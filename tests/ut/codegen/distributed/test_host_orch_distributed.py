...
def test_dist_tensor_formal_emits_buffer_tensor():
    @pl.program
    class Prog:
...
def test_two_groups_emit_nested_allocate_domain():
    ...
    # group A dispatches through __comm_d0[...].buffers["buf_a"].tensor(...)
...
def test_implicit_host_allreduce_builtin_codegen_materializes_signal():
    ...
    assert 'callables["builtin.tensor.allreduce__sum__fp32"]' in generated, generated
    assert (
        'buffers["__allreduce_signal_buf_0"].tensor('
        "shapes=(__allreduce_signal_world_size_0, 1), dtype=DataType.INT32)" in generated
    ), generated
    assert 'buffers["data_buf"].tensor(shapes=(64,), dtype=DataType.FLOAT32)' in generated, generated
